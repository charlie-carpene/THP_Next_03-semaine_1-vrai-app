...
const PageDetail = (argument) => {
          ...
          articleDOM.innerHTML = `
            ...
            <div class="container">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                ...
                <p class="w-25"><strong>Developer</strong><br/>${Button(developers[0].name, 'text-danger')}</p>
              ...
              <div class="d-flex justify-content-between flex-wrap">
              <p class="w-50"><strong>Genre</strong><br/>${genres.map((genre) => ` ${genre.name}`)}</p>
              <p class="w-50"><strong>Tags</strong><br/>${tags.map((tag) => ` ${tag.name}`)}</p>
              </div>
            </div>
          `;
  ...
  function addEventListenerToLinks(response) {
    ...
    a[3].addEventListener("click", handleClick);
